...
function pagination($per_page = 4, $page = 1, $url = '?')
{
    ...
    $result = $db->query("SELECT COUNT(*) as `num` FROM accessories");
...
if ((session()->has('MenAccID'))) {
    $MenAccID = session()->get('MenAccID');
}
else{
       return redirect()->to('/');
}
$db = db_connect();
$result = $db->query("SELECT * FROM `accessories` WHERE `men_acces_id`= $MenAccID ORDER BY `id` ASC LIMIT {$startpoint} , {$per_page}");
    ...
    ?>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 product" data-aos="fade-up" data-aos-delay="200">
                            <div class="product-inner">
                                <div class="thumb">
                                 <a href="<?php echo base_url(); ?>AcessoriessProduct-Details/<?php echo $id ?>" class="image">
                                <img class="first-image" src="<?php echo base_url(); ?>/assets/images/uploads/accessories/<?php echo $image1; ?>" alt="Product" />
                                <img class="second-image" src="<?php echo base_url(); ?>/assets/images/uploads/accessories//<?php echo $image2; ?>" alt="Product" />
                            </a>
                                ...
                                <div class="content">
                                    ...
                                    <div class="shop-list-btn">
                                        ...
                                        <a href="<?php echo base_url(); ?>AcessoriessProduct-Details/<?php echo $id ?>">
