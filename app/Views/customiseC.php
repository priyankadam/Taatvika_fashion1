...
<?= $this->section('content'); ?>
   ...
   <div class="section section-margin">
        <div class="container">
                <?php 
                 if ((session()->has('CollectionProductID'))) { 
                         $CPID = session()->get('CollectionProductID');
                   }
                     if ((session()->has('CollectionID'))) { 
                 ...
                 $db = db_connect();
                $result = $db->query("SELECT * FROM `collection` WHERE `Collection_id`=$CID and ID=$CPID");
                    ...
                    <div class="product-details-img">
                        ...
                        <div class="single-product-img swiper-container gallery-top">
                            <div class="swiper-wrapper popup-gallery">
                                <?php if(isset($image1)){?>
                                <a class="swiper-slide w-100" href="<?php echo base_url();?>/assets/images/uploads/collections/<?php echo $image1; ?>">
                                    <img class="w-100" src="<?php echo base_url();?>/assets/images/uploads/collections/<?php echo $image1; ?>" alt="Product">
                                </a>
                                 <?php } ?>
                                  <?php if(isset($image2)){?>
                                <a class="swiper-slide w-100" href="<?php echo base_url();?>/assets/images/uploads/collections/<?php echo $image2; ?>">
                                    <img class="w-100" src="<?php echo base_url();?>/assets/images/uploads/collections/<?php echo $image2; ?>" alt="Product">
                                </a>
                                  <?php } ?>
                                 <?php if(isset($image3)){?>
                                <a class="swiper-slide w-100" href="<?php echo base_url();?>/assets/images/uploads/collections/<?php echo $image3; ?>">
                                    <img class="w-100" src="<?php echo base_url();?>/assets/images/uploads/collections/<?php echo $image3; ?>" alt="Product">
                                </a>
                                  <?php } ?>
                                 <?php if(isset($image4)){?>
                                <a class="swiper-slide w-100" href="<?php echo base_url();?>/assets/images/uploads/collections/<?php echo $image4; ?>">
                                    <img class="w-100" src="<?php echo base_url();?>/assets/images/uploads/collections/<?php echo $image4; ?>" alt="Product">
                                </a>
                                 <?php } ?>
                                 <?php if(isset($image5)){?>
                                <a class="swiper-slide w-100" href="<?php echo base_url();?>/assets/images/uploads/collections/<?php echo $image5; ?>">
                                    <img class="w-100" src="<?php echo base_url();?>/assets/images/uploads/collections/<?php echo $image5; ?>" alt="Product">
                                </a>
                                 <?php } ?>
                                 <?php if(isset($image6)){?>
                                <a class="swiper-slide w-100" href="<?php echo base_url();?>/assets/images/uploads/collections/<?php echo $image6; ?>">
                                    <img class="w-100" src="<?php echo base_url();?>/assets/images/uploads/collections/<?php echo $image6; ?>" alt="Product">
                                </a>
                                 <?php } ?>
                            </div>
                        </div>
                        ...
                        <div class="single-product-thumb swiper-container gallery-thumbs">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img src="<?php echo base_url();?>/assets/images/uploads/collections/<?php echo $image1; ?>" alt="Product">
                                </div>
                                 <?php } ?>
                                 <?php if(isset($image2)){?>
                                <div class="swiper-slide">
                                    <img src="<?php echo base_url();?>/assets/images/uploads/collections/<?php echo $image2; ?>" alt="Product">
                                </div>
                                 <?php } ?>
                                 <?php if(isset($image3)){?>
                                <div class="swiper-slide">
                                    <img src="<?php echo base_url();?>/assets/images/uploads/collections/<?php echo $image3; ?>" alt="Product">
                                </div>
                                 <?php } ?>
                                 <?php if(isset($image4)){?>
                                <div class="swiper-slide">
                                    <img src="<?php echo base_url();?>/assets/images/uploads/collections/<?php echo $image4; ?>" alt="Product">
                                </div>
                                 <?php } ?>
                                 <?php if(isset($image5)){?>
                                <div class="swiper-slide">
                                    <img src="<?php echo base_url();?>/assets/images/uploads/collections/<?php echo $image5; ?>" alt="Product">
                                </div>
                                 <?php } ?>
                                 <?php if(isset($image6)){?>
                                <div class="swiper-slide">
                                    <img src="<?php echo base_url();?>/assets/images/uploads/collections/<?php echo $image6; ?>" alt="Product">
                                </div>
                                 <?php } ?>
                            </div>
                            ...
                            <div class="product-size">
                                ...
                                <div class="row pt-4">
                                    <div class="col-md-4 col-lg-4 col-xl-4">
                                        <label class="pb-2">Bust</label>
                                        <select class="form-select" aria-label="Default select example" name="bust" required>
                                        <option value="">Please Select Bust Size</option>
                                    ...
                                    <div class="col-md-4 col-lg-4 col-xl-4">  
                                    <label class="pb-2">Waist</label>
                                         <select class="form-select" aria-label="Default select example" name="waist" required>
                                         <option value="">Please Select Waist Size</option>
                                          <option value="1">One</option>
                                          <option value="2">Two</option>
                                          <option value="3">Three</option>
                                        </select>
                                     ...
                                     <div class="col-md-4 col-lg-4 col-xl-4"> 
                                     <label class="pb-2">Hip</label>
                                         <select class="form-select" aria-label="Default select example" name="hip" required>
                                         <option value="">Please Select Hip Size</option>
                                          <option value="1">One</option>
                                          <option value="2">Two</option>
                                          <option value="3">Three</option>
                                        </select>
