...
function pagination($per_page = 4, $page = 1, $url = '?')
{
    ...
    $result = $db->query("SELECT COUNT(*) as `num` FROM Mens");
            ...
            <div class="col-12">
                ...
                <div class="shop_toolbar_wrapper flex-column flex-md-row mb-10">
                    ...
                    <div class="shop-top-bar-right">
                        ...
                        <!--    <select class="nice-select" aria-label=".form-select-sm example" name="selectdisplay">-->
...
if(isset($ss)){
   // echo"if loop";
$db = db_connect();
$result = $db->query("SELECT * FROM `Mens` WHERE `Men_id`= $ss ORDER BY `Id` ASC LIMIT {$startpoint} , {$per_page}");

// $result = $db->query("SELECT * FROM `Mens` WHERE `Men_id`=$ss");
    ...
    ?>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 product" data-aos="fade-up" data-aos-delay="200">
                            <div class="product-inner">
                                <div class="thumb">
                                <a href="<?php echo base_url(); ?>Product-Details/<?php echo $id ?> " class="image">
                                <img class="first-image" src="<?php echo base_url(); ?>/assets/images/uploads/mens/<?php echo $image1; ?>" alt="Product" />
                                <img class="second-image" src="<?php echo base_url(); ?>/assets/images/uploads/mens//<?php echo $image2; ?>" alt="Product" />
                            </a>
                                ...
                                <div class="content">
                                    ...
                                    <div class="shop-list-btn">
                                        ...
                                        <a href="<?php echo base_url(); ?>Product-Details/<?php echo $id ?>">
...
//var_dump($_POST['prod_code']);exit();
      

      if(isset($prod_code)){
    foreach ($prod_code as $code) {
            
$result = $db->query("SELECT * FROM `mens` WHERE `ProductCode`='$code' ORDER BY `Id` ASC LIMIT {$startpoint} , {$per_page}");
// $result = $db->query("SELECT * FROM `Mens` WHERE `Men_id`=$ss");
foreach ($result->getResult() as $key) {
//var_dump($key);exit();
    $fold = 'mens';
    ...
    ?>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 product" data-aos="fade-up" data-aos-delay="200">
                            <div class="product-inner">
                                <div class="thumb">
                                <a href="<?php echo base_url(); ?>Product-Details/<?php echo $id ?> " class="image">
                                <img class="first-image1" src="<?php echo base_url(); ?>/assets/images/uploads/mens/<?php echo $image1; ?>" alt="Product" />
                                <img class="second-image2" src="<?php echo base_url(); ?>/assets/images/uploads/mens//<?php echo $image2; ?>" alt="Product" />
                            </a>
                                   
                                </div>
                                <div class="content">
                                    <h4 class="sub-title1"><a href="#"><?php echo $Brand ?></a></h4>
                                    <h5 class="title1"><a href="#"><?php echo $Product_name ?></a></h5>
...
var data = JSON.parse(localStorage.getItem('prod_code'));
   // console.log(data);
...
for (let i = 0; i < data.length; i++) {
   ...
   console.log(data[i].Id);
     $('.title1').text(data[i].Product_name);
     $('.first-image1').html("<img width='100' src='https://digileadz.com/sirsonite/Beseen/assets/images/uploads/mens/" + data[i].image1 + "'>");
    $('.second-image2').html("<img width='100' src='https://digileadz.com/sirsonite/Beseen/assets/images/uploads/mens/" + data[i].image2 + "'>");
