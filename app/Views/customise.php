...
<?= $this->section('content'); ?>
   ...
   <div class="section section-margin">
        <div class="container">
               <?php 
                 if ((session()->has('MenProductID'))) { 
                         $vv = session()->get('MenProductID');
                   }
                     if ((session()->has('MenID'))) { 
                         $ss = session()->get('MenID');
                   }
                   else{
                      return redirect()->to('/');
                   }
                 ...
                 $db = db_connect();
                $result = $db->query("SELECT * FROM `Mens` WHERE `Men_id`=$ss and ID=$vv");
                    ...
                    <div class="product-details-img">
                        ...
                        <div class="single-product-img swiper-container gallery-top">
                            <div class="swiper-wrapper popup-gallery">
                                <a class="swiper-slide w-100" href="<?php echo base_url();?>/assets/images/uploads/mens/<?php echo $image1; ?>">
                                    <img class="w-100" src="<?php echo base_url();?>/assets/images/uploads/mens/<?php echo $image1; ?>" alt="Product">
                                </a>
                                <a class="swiper-slide w-100" href="<?php echo base_url();?>/assets/images/uploads/mens/<?php echo $image2; ?>">
                                    <img class="w-100" src="<?php echo base_url();?>/assets/images/uploads/mens/<?php echo $image2; ?>" alt="Product">
                                </a>
                                <a class="swiper-slide w-100" href="<?php echo base_url();?>/assets/images/uploads/mens/<?php echo $image3; ?>">
                                    <img class="w-100" src="<?php echo base_url();?>/assets/images/uploads/mens/<?php echo $image3; ?>" alt="Product">
                                </a>
                                <a class="swiper-slide w-100" href="<?php echo base_url();?>/assets/images/uploads/mens/<?php echo $image4; ?>">
                                    <img class="w-100" src="<?php echo base_url();?>/assets/images/uploads/mens/<?php echo $image4; ?>" alt="Product">
                                </a>
                                <a class="swiper-slide w-100" href="<?php echo base_url();?>/assets/images/uploads/mens/<?php echo $image5; ?>">
                                    <img class="w-100" src="<?php echo base_url();?>/assets/images/uploads/mens/<?php echo $image5; ?>" alt="Product">
                                </a>
                                <a class="swiper-slide w-100" href="<?php echo base_url();?>/assets/images/uploads/mens/<?php echo $image6; ?>">
                                    <img class="w-100" src="<?php echo base_url();?>/assets/images/uploads/mens/<?php echo $image6; ?>" alt="Product">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="single-product-thumb swiper-container gallery-thumbs">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img src="<?php echo base_url();?>/assets/images/uploads/mens/<?php echo $image1; ?>" alt="Product">
                                </div>
                                <?php } ?>
                                <?php if(isset($image2)){?>
                                <div class="swiper-slide">
                                    <img src="<?php echo base_url();?>/assets/images/uploads/mens/<?php echo $image2; ?>" alt="Product">
                                </div>
                                 <?php } ?>
                                <?php if(isset($image3)){?>
                                <div class="swiper-slide">
                                    <img src="<?php echo base_url();?>/assets/images/uploads/mens/<?php echo $image3; ?>" alt="Product">
                                </div>
                                 <?php } ?>
                                <?php if(isset($image4)){?>
                                <div class="swiper-slide">
                                    <img src="<?php echo base_url();?>/assets/images/uploads/mens/<?php echo $image4; ?>" alt="Product">
                                </div>
                                 <?php } ?>
                                <?php if(isset($image5)){?>
                                <div class="swiper-slide">
                                    <img src="<?php echo base_url();?>/assets/images/uploads/mens/<?php echo $image5; ?>" alt="Product">
                                </div>
                                 <?php } ?>
                                <?php if(isset($image6)){?>
                                <div class="swiper-slide">
                                    <img src="<?php echo base_url();?>/assets/images/uploads/mens/<?php echo $image6; ?>" alt="Product">
                                </div>
                                 <?php } ?>
                            </div>
