...
?>
    ...
    ?>
                            ...
                            <div class="swiper-button-horizental-next  swiper-button-next"><span><img src="assets/images/icons/left_angle.png" style="width:30px;"></span></div>
                ...
                <div class="col-lg-7 col-custom">
                    ...
                    <div class="product-summery position-relative">
                        ...
                        <div class="product-meta mb-3">
                            <!-- Product Size Start -->
                            <form method="post" action="<?php echo base_url(); ?>Add-to-cart-customise-single" id="myform">
