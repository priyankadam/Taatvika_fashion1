...
<?= $this->section('content'); ?>
   ...
   <div class="section section-margin">
        <div class="container">
               <?php 
                 if ((session()->has('MenACCProductID'))) { 
                         $MenACCProductID = session()->get('MenACCProductID');
                   }
                 ...
                 $db = db_connect();
                $result = $db->query("SELECT * FROM `accessories`  WHERE `men_acces_id`=$MenAccID and ID=$MenACCProductID");
                               ...
                               <?php 
                                ...
                                $material_ids = explode(",", $size);
                                    foreach ($material_ids as $key1) {
                                        ...
                                        ?>
                                         <input type="radio" id="material" name="material" value="<?php echo $key1 ?>" /> <?php echo $materialname ?>
