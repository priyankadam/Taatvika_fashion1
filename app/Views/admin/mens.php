    ...
    <!-- <div class="row m-2 showkeyfeaturesdiv ">
        <div class="card  col-12">
            <div class="card-header">
                <h4 class="box-title m-b-0">Choose Mens Category</h4>
            </div>
            <div class="card-body">

                <div class="message mb-3"></div>
                <div class="control-group mb-3">
                    <label class="control-label">Mens Category :</label>
                    <div class="controls">
                        <select class="form-control" name="men_cat" id="men_cat">

                            <option value="">--Select Mens Type--</option>
                            <?php
                            $db      = \Config\Database::connect();
                            $query11  = $db->query("SELECT * FROM mens_master");
                            ?>
                            <?php foreach ($query11->getResult() as $row11) : ?>
                                <option value="<?php echo $row11->Id ?>"><?php echo $row11->men_category; ?></option>
                            <?php endforeach; ?>
    ...
    <div class="row m-2 showkeyfeaturesdiv buildcoursediv">
        <div class="card  col-12">
            <div class="card-header">
                <h4 class="box-title m-b-0">Add Mens Product</h4>
            </div>
            <div class="card-body">
                            ...
                            <div class="card-body">
                                ...
                                <form method="" enctype="multipart/form-data" id="RecordForm">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="file" class="form-control" id="ProductImage1" name="ProductImage1" ><span id="img_error1" class="text-danger ms-3 error" style="font-size: 13px;" required></span>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="Banner_Image">Choose Product Image 2 *</label><span style="color:red;">Image Size Only greater than or 470 * 470</span>
                                        <input type="file" class="form-control" id="ProductImage2" name="ProductImage2"><span id="img_error2" class="text-danger ms-3 error" style="font-size: 13px;"></span>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="Banner_Image">Choose Product Image 3 *</label><span style="color:red;">Image Size Only greater than or 470 * 470</span>
                                        <input type="file" class="form-control" id="ProductImage3" name="ProductImage3"><span id="img_error3" class="text-danger ms-3 error" style="font-size: 13px;"></span>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="Banner_Image">Choose Product Image 4 *</label><span style="color:red;">Image Size Only greater than or 470 * 470</span>
                                        <input type="file" class="form-control" id="ProductImage4" name="ProductImage4"><span id="img_error4" class="text-danger ms-3 error" style="font-size: 13px;"></span>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="Banner_Image">Choose Product Image 5 *</label><span style="color:red;">Image Size Only greater than or 470 * 470</span>
                                        <input type="file" class="form-control" id="ProductImage5" name="ProductImage5"><span id="img_error5" class="text-danger ms-3 error" style="font-size: 13px;"></span>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="Banner_Image">Choose Product Image 6 *</label><span style="color:red;">Image Size Only greater than or 470 * 470</span>
                                        <input type="file" class="form-control" id="ProductImage6" name="ProductImage6"><span id="img_error6" class="text-danger ms-3 error" style="font-size: 13px;"></span>
                                    </div>
    ...
    <script type="text/javascript">
        ...
        // // -------------------
        // function readMultipleFiles1(fileList,id) {
    ...
    {
       var el= document.getElementById('men_cat');
