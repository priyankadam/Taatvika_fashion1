...
function pagination($per_page = 4, $page = 1, $url = '?')
{
    ...
    $result = $db->query("SELECT COUNT(*) as `num` FROM collection");
...
$db = db_connect();
$result = $db->query("SELECT * FROM `collection` WHERE `Collection_id`= $CID ORDER BY `Id` ASC LIMIT {$startpoint} , {$per_page}");

//$result = $db->query("SELECT * FROM `collection` WHERE Collection_id=$CID");
    ...
    ?>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 product" data-aos="fade-up" data-aos-delay="200">
                        <div class="product-inner">
                            <div class="thumb">
                                <a href="<?php echo base_url(); ?>CollectionProduct-Details/<?php echo $id ?>" class="image">
                                    <img class="first-image" src="<?php echo base_url(); ?>/assets/images/uploads/collections/<?php echo $image1; ?>" alt="Product" />
                                    <img class="second-image" src="<?php echo base_url(); ?>/assets/images/uploads/collections/<?php echo $image2; ?>" alt="Product" />
                                </a>
                            ...
                            <div class="content">
                                ...
                                <div class="shop-list-btn">
                                 ...
                                 <a href="<?php echo base_url(); ?>CollectionProduct-Details/<?php echo $id ?>">
                                            <button class="btn btn-sm btn-outline-dark btn-hover-primary">Add To Cart1</button></a>
