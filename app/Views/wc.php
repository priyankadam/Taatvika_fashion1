    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row shop_wrapper grid_4">
                 <?php 
                 $db = db_connect();
                $result = $db->query("SELECT * FROM `Mens` WHERE `Men_id`='2'");
                ...
                <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 product" data-aos="fade-up" data-aos-delay="200">
                    <div class="product-inner">
                        <div class="thumb">
                            <a href="<?php echo base_url(); ?>ProductSuit" class="image">
                                <img class="first-image" src="<?php echo base_url();?>/assets/images/uploads/mens/image1/<?php echo $image1; ?>" alt="Product" />
                                <img class="second-image" src="<?php echo base_url();?>/assets/images/uploads/mens/image2/<?php echo $image2; ?>" alt="Product" />
                            </a>
                            <div class="actions">
                        ...
                        <div class="content">
                            ...
                            <span class="price">
                                    <span class="new">Rs.<?php echo $Product_price ?></span>
                            <span class="old">Rs.<?php echo $Product_price ?></span>
                            </span>
