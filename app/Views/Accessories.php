...
$db = db_connect();
$result = $db->query("SELECT * FROM `accessories` WHERE `women_acces_id`= $WomenAccID ORDER BY `id` ASC LIMIT {$startpoint} , {$per_page}");
    ...
    ?>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 product" data-aos="fade-up" data-aos-delay="200">
                            <div class="product-inner">
                                <div class="thumb">
                                 <a href="<?php echo base_url(); ?>AcessoriesProduct-Details/<?php echo $id ?>" class="image">
                                ...
                                <div class="content">
                                    ...
                                    <div class="shop-list-btn">
                                        ...
                                        <a href="<?php echo base_url(); ?>AcessoriesProduct-Details/<?php echo $id ?>">
