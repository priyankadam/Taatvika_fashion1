                        ...
                        <div class="tab-pane fade" id="connect-4" role="tabpanel" aria-labelledby="review-tab">
                            <div class="size-tab table-responsive-lg">
                                ...
                                <table class="table border mb-0">
                                    <tbody>
                                        <tr>
                                            <th class="cun-name"><span>US</span></th>
                                            <th class="cun-name"><span>INDIA</span></th>
                                            <th class="cun-name"><span>UK</span></th>
                                            <th class="cun-name"><span>EURO</span></th>
                                            <th class="cun-name"><span>CM</span></th>
                                        </tr>
                                        <tr>
                                            <td>7</td>
                                            <td>6</td>
